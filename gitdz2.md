...
конфликтная страка для пнукат 7


## Работа с удаленным репозиторием

Для того, чтобы полностью скопировать удаленный репозиторий к себе на компьюетр, необходимо выполнить команду:
```
git clone
```

Для того, чтобы получить и применить последние изменения для ранее склонированного репозитория, необходимо выполнить команду:
```
git pull
```

Для того, чтобы отправить локальные сохранненные (commited) изменения удалённый репозиторий, необходимо выполнить команду:
```
git push
```